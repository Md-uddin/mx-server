...
app.post("/api/get_mxconnect_widget_url", async function (request, response) {
  try {
    ...
    const widgetResponse = await client.requestWidgetURL(
      userGuid,
      widgetRequestBody
    );
...
app.get(
  ...
  async function (request, response) {
    try {
      const listUserAccountsResponse = await client.listUserAccounts(
...
app.get(
  "/users/:userGuid/members/:memberGuid/verify",
  async function (request, response) {
    try {
      const listAccountNumbersResponse =
        await client.listAccountNumbersByMember(
          request.params.memberGuid,
          request.params.userGuid
        );
...
app.get(
  "/users/:userGuid/members/:memberGuid/identify",
  async function (request, response) {
    try {
